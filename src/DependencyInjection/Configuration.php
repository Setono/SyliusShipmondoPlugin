            ...
            ->children()
                ->arrayNode('api')
                    ...
                    ->children()
                        ...
                        ->end()
                        ->scalarNode('sandbox')
                            ->info('If true, the Shipmondo sandbox API is used instead of the production API. Defaults to the SHIPMONDO_SANDBOX environment variable (false if unset).')
                            ->defaultValue('%env(bool:SHIPMONDO_SANDBOX)%')
                        ->end()
                    ->end()
                ->end()
                ->arrayNode('webhooks')
